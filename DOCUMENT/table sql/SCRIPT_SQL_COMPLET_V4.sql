-- ============================================================
-- EASY INCENDIE - SCRIPT SQL COMPLET V4
-- ⚠️ ORDRE CORRIGÉ pour éviter les erreurs de dépendances
...
-- ============================================================
-- ÉTAPE 2 : Maintenant on peut supprimer la fonction
-- ============================================================

DROP FUNCTION IF EXISTS public.get_user_organisation_id();

-- ============================================================
-- ÉTAPE 3 : Recréer la fonction
-- ============================================================
...
-- ============================================================
-- ÉTAPE 4 : Ajouter auth_id à utilisateurs si n'existe pas
-- ============================================================
...
-- ============================================================
-- ÉTAPE 5 : Créer les tables SI elles n'existent pas
-- ============================================================
...
EXCEPTION WHEN OTHERS THEN
  RAISE NOTICE 'Contrainte existe déjà ou erreur ignorée';
END $$;
...
-- ============================================================
-- ÉTAPE 6 : RECRÉER TOUTES LES POLICIES RLS
-- ============================================================
...
-- ============================================================
-- ÉTAPE 7 : Fonction RPC complete_registration CORRIGÉE
-- ============================================================
...
BEGIN
  ...
  -- Créer l'organisation (COLONNES RÉELLES UNIQUEMENT!)
  ...
  -- Créer l'onboarding progress (COLONNES RÉELLES: step_xxx)
  ...
  -- Mettre à jour le prospect si existe
...
-- ============================================================
-- ÉTAPE 8 : Fonction RPC create_subscription
-- ============================================================
...
SELECT '=== SCRIPT V4 TERMINÉ AVEC SUCCÈS ===' AS result;
