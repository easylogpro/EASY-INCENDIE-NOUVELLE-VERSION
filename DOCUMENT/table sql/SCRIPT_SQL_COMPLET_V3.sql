-- ============================================================
-- EASY INCENDIE - SCRIPT SQL COMPLET V3
-- FUSION de SOLUTION_COMPLETE_FLUX.sql + CORRECTIONS V2
...
-- 3. Configuration RLS complète
-- 4. Fonctions RPC CORRIGÉES (colonnes réelles)
--
-- ============================================================

-- ============================================================
-- ÉTAPE 1 : Ajouter auth_id à utilisateurs si n'existe pas
-- ============================================================
...
-- ============================================================
-- ÉTAPE 2 : Fonction get_user_organisation_id()
-- ============================================================
...
-- ============================================================
-- ÉTAPE 3 : Créer les tables SI elles n'existent pas
-- ============================================================
...
-- Table onboarding_progress (avec les VRAIES colonnes step_xxx)
CREATE TABLE IF NOT EXISTS onboarding_progress (
  ...
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  CONSTRAINT onboarding_progress_org_unique UNIQUE(organisation_id)
);
...
-- ============================================================
-- ÉTAPE 4 : RLS pour demandes_prospects
-- ============================================================
...
-- ============================================================
-- ÉTAPE 6 : RLS pour organisations
-- ============================================================
...
-- ============================================================
-- ÉTAPE 9 : Fonction RPC complete_registration 
-- ⚠️ CORRIGÉE avec les VRAIES colonnes !
-- ============================================================
...
BEGIN
  ...
  -- ⚠️ Utilise UNIQUEMENT les colonnes qui EXISTENT RÉELLEMENT:
  ...
  -- 
  -- ❌ N'EXISTENT PAS: formule, module_ssi, module_desenfumage, 
  --    module_portes_cf, module_baes, module_extincteurs, module_ria, actif
  -- ============================================================
  ...
  -- ⚠️ Utilise les VRAIES colonnes: step_profil, step_logo, etc.
...
-- ============================================================
-- ÉTAPE 10 : Fonction RPC create_subscription (CORRIGÉE)
-- ============================================================
